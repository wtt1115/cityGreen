...
Page({
  ...
  moveIphoneInput: function (e) {
    this.setData({
      moveIphone: e.detail.value
    })
  },
  ...
  bindFormSubmit: function () {
    ...
    if (this.data.moveIphone) {
      if (!iphoneReg.test(this.data.moveIphone)) {
        wx.showToast({
          title: '请输入正确的联系电话!',
          icon: 'none',
          duration: 2000
        ...
        detailsInfo.moveIphone = this.data.moveIphone;
      }
    }
    if (this.data.title) {
      detailsInfo.title = this.data.title;
